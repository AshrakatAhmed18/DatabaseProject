...
<report name="Report" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="REPORT" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="P_1" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL GRADES.ID, GRADES.STUDENTGRADE, 
GRADES.EXAMGRADE, INCOME.ID, INCOME.PAYMENTDATE
FROM GRADES, INCOME ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_ID">
        <displayInfo x="1.23083" y="1.94995" width="1.53845" height="1.15942"
        />
        <dataItem name="ID" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Id">
          <dataDescriptor expression="GRADES.ID" descriptiveExpression="ID"
           order="1" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="STUDENTGRADE" oracleDatatype="number" columnOrder="12"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Studentgrade">
          <dataDescriptor expression="GRADES.STUDENTGRADE"
           descriptiveExpression="STUDENTGRADE" order="2" width="22"
           precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="EXAMGRADE" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Examgrade">
          <dataDescriptor expression="GRADES.EXAMGRADE"
           descriptiveExpression="EXAMGRADE" order="3" width="22"
           precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PAYMENTDATE" datatype="vchar2" columnOrder="15"
         width="20" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Paymentdate">
          <dataDescriptor expression="INCOME.PAYMENTDATE"
           descriptiveExpression="PAYMENTDATE" order="5" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID1" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Id1">
          <dataDescriptor expression="INCOME.ID" descriptiveExpression="ID"
           order="4" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="SumSTUDENTGRADEPerReport" source="STUDENTGRADE"
    ...
    <summary name="SumEXAMGRADEPerReport" source="EXAMGRADE" function="sum"
     width="22" precision="38" reset="report" compute="report"
     defaultWidth="90000" defaultHeight="10000" columnFlags="552"
     defaultLabel="Total:">
      <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"/>
    </summary>
    <summary name="CountPAYMENTDATEPerReport" source="PAYMENTDATE"
  ...
  <section name="main">
    <body>
      <frame name="M_G_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="4.56250" height="0.75000"
        />
        ...
        <repeatingFrame name="R_G_ID" source="G_ID" printDirection="down"
         minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="4.56250"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Background2"/>
          <field name="F_ID" source="ID" minWidowLines="1" spacing="0"
           alignment="start">
          ...
          <field name="F_STUDENTGRADE" source="STUDENTGRADE" minWidowLines="1"
          ...
          <field name="F_EXAMGRADE" source="EXAMGRADE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="1.68750" y="0.18750" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_PAYMENTDATE" source="PAYMENTDATE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="3.06250" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_ID_FTR">
          ...
          <field name="F_SumSTUDENTGRADEPerReport"
           source="SumSTUDENTGRADEPerReport" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.31250" y="0.37500" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          ...
          <field name="F_SumEXAMGRADEPerReport" source="SumEXAMGRADEPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="1.68750" y="0.37500" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_CountPAYMENTDATEPerReport"
           source="CountPAYMENTDATEPerReport" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="3.06250" y="0.56250" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_ID_HDR">
          <geometryInfo x="0.00000" y="0.00000" width="4.56250"
           height="0.18750"/>
          ...
          <text name="B_STUDENTGRADE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.31250" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="custom6"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_EXAMGRADE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.68750" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="custom6"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_PAYMENTDATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.06250" y="0.00000" width="1.50000"
             height="0.18750"/>
    ...
    <margin>
      <image name="B_1_SEC2" templateSection="main">
        <geometryInfo x="0.50000" y="0.43750" width="1.43750" height="0.37500"
        />
        <visualSettings fillPattern="transparent" fillBackgroundColor="black"
         linePattern="transparent" lineBackgroundColor="black"/>
        <points>
          <point x="0.00000" y="0.00000"/>
          <point x="1.43750" y="0.37500"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwwine" sectionTitle="MyReport"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGIDGRPFR192">
<table class="OraTable">
<caption> MyReport </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBID192" asArray="no"/> class="OraColumnHeader"> Id </th>
   <th <rw:id id="HBSTUDENTGRADE192" asArray="no"/> class="OraColumnHeader"> Studentgrade </th>
   <th <rw:id id="HBEXAMGRADE192" asArray="no"/> class="OraColumnHeader"> Examgrade </th>
   <th <rw:id id="HBPAYMENTDATE192" asArray="no"/> class="OraColumnHeader"> Paymentdate </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGID1921" src="G_ID">
   <tr>
    <td <rw:headers id="HFID192" src="HBID192"/> class="OraCellNumber"><rw:field id="FID192" src="ID" nullValue="&nbsp;"> F_ID </rw:field></td>
    <td <rw:headers id="HFSTUDENTGRADE192" src="HBSTUDENTGRADE192"/> class="OraCellNumber"><rw:field id="FSTUDENTGRADE192" src="STUDENTGRADE" nullValue="&nbsp;"> F_STUDENTGRADE </rw:field></td>
    <td <rw:headers id="HFEXAMGRADE192" src="HBEXAMGRADE192"/> class="OraCellNumber"><rw:field id="FEXAMGRADE192" src="EXAMGRADE" nullValue="&nbsp;"> F_EXAMGRADE </rw:field></td>
    <td <rw:headers id="HFPAYMENTDATE192" src="HBPAYMENTDATE192"/> class="OraCellText"><rw:field id="FPAYMENTDATE192" src="PAYMENTDATE" nullValue="&nbsp;"> F_PAYMENTDATE </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <td <rw:headers id="HFSumSTUDENTGRADEPerReport192" src="HBSTUDENTGRADE192"/> class="OraTotalNumber">Total: <rw:field id="FSumSTUDENTGRADEPerReport192" src="SumSTUDENTGRADEPerReport" nullValue="&nbsp;"> F_SumSTUDENTGRADEPerReport </rw:field></td>
  <td <rw:headers id="HFSumEXAMGRADEPerReport192" src="HBEXAMGRADE192"/> class="OraTotalNumber">Total: <rw:field id="FSumEXAMGRADEPerReport192" src="SumEXAMGRADEPerReport" nullValue="&nbsp;"> F_SumEXAMGRADEPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
 <tr>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFCountPAYMENTDATEPerReport192" src="HBPAYMENTDATE192"/> class="OraTotalNumber">Count: <rw:field id="FCountPAYMENTDATEPerReport192" src="CountPAYMENTDATEPerReport" nullValue="&nbsp;"> F_CountPAYMENTDATEPerReport </rw:field></td>
 </tr>
</table>
</rw:dataArea> <!-- id="MGIDGRPFR192" -->
